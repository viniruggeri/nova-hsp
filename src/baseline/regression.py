...
class RegressionBaselines:
    ...
    def train_gradient_boosting(X_train: np.ndarray, y_train: np.ndarray, 
        ...
        try:
            ...
            r2 = 1 - np.sum((y_pred - y_test) ** 2) / np.sum((y_test.mean() - y_test) ** 2)
    ...
    @staticmethod
    def train_ridge_regression_time(X_train: np.ndarray, y_train: np.ndarray,
                                    X_test: np.ndarray, y_test: np.ndarray) -> dict:
    ...
    @staticmethod
    def train_mlp_regression(X_train: np.ndarray, y_train: np.ndarray,
                            X_test: np.ndarray, y_test: np.ndarray,
                            device='cpu', epochs=50) -> dict:
        ...
        try:
            ...
            r2 = 1 - np.sum((y_pred - y_test_np) ** 2) / np.sum((y_test_np.mean() - y_test_np) ** 2)
