...
print("\n" + aggregated[['model_name', 'MAE_mean', 'MAE_std', 'c_index_mean']].to_string(index=False))
...
if not comparison.empty:
    print("\n" + comparison[['model_name', 'kruskal_h', 'kruskal_p', 'significant']].to_string(index=False))
...
if not pairwise.empty:
    print("\n" + pairwise[['model_name', 'sir_graph_mean', 'ant_colony_mean', 'p_value']].to_string(index=False))
